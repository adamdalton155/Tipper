...
const onConfirmPressed = async() =>{
    try {
        const response = await Auth.confirmSignUp(route.params.email, smsCode)
...
return(
    <View style={styles.root}>
        ...
        <TextInput style={styles.container} placeholder="Enter verification code" value={smsCode} onChangeText={setSmsCode}/>
